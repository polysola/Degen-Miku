jQuery(document).ready(function () {
  ...
  function getTelegramUser() {
    if (isTelegramWebApp) {
      try {
        ...
        console.log("Telegram WebApp User:", webAppUser);
    ...
    console.log("Generated Web User ID:", userId);
    return false;
  }
  ...
  // Request fullscreen if in Telegram WebApp
  if (isTelegramWebApp) {
    try {
  ...
  function updateUserProfile() {
    ...
    if (userType === "telegram" && userInfo) {
      if (userInfo.photo_url) {
        console.log("Setting photo URL:", userInfo.photo_url);
        jQuery("#userAvatar").attr("src", userInfo.photo_url);
      }
      const displayName =
        userInfo.first_name +
